  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-5">
        ...
        <Receipt
          className="absolute top-40 right-20 w-16 h-16 md:w-20 md:h-20 animate-float text-accent"
          style={{ animationDelay: "2s" }}
        />
        <Receipt
          className="absolute bottom-32 left-1/4 w-8 h-8 md:w-12 md:h-12 animate-float text-primary"
          style={{ animationDelay: "4s" }}
        />
        <BarChart3
          className="absolute top-1/3 right-1/4 w-12 h-12 md:w-16 md:h-16 animate-float text-accent"
          style={{ animationDelay: "1s" }}
        />
        <Calculator
          className="absolute bottom-20 right-10 w-10 h-10 md:w-14 md:h-14 animate-float text-primary"
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full glass-card mb-4 md:mb-6 animate-pulse-glow">
            ...
            <span className="text-xs md:text-sm text-foreground">
              Automated AI Bookkeeping — Try It Free
            </span>
          </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 leading-tight animate-fade-up px-2">
            ...
            <br />
            <span className="text-primary neon-glow">AI Bookkeeper</span>
          </h1>

          <p
            className="text-sm sm:text-base md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-up px-4"
            style={{ animationDelay: "0.2s" }}
          >
            Upload a receipt or CSV. Get categorized entries, dashboards, and
            AI-driven recommendations instantly.
          </p>

          <div
            className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center animate-fade-up px-4"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-20">
          <div className="glass-card-hover p-6 md:p-8 rounded-2xl hover-lift animate-fade-up">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Extract data from PDF receipts, images, and CSV files
              automatically with AI-powered recognition
            </p>
          </div>

          <div
            className="glass-card-hover p-6 md:p-8 rounded-2xl hover-lift animate-fade-up"
            style={{ animationDelay: "0.2s" }}
          >
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Real-time charts and KPIs updated with every upload. Track your
          ...
          >
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Smart predictions, spending patterns, and personalized cost-saving
              recommendations
            </p>
          </div>
        </div>
        ...
        <div className="mt-20 md:mt-32 text-center">
          <div className="glass-card-hover p-8 md:p-12 rounded-3xl max-w-4xl mx-auto animate-scale-in neon-border">
            ...
            <p className="text-base md:text-xl text-muted-foreground mb-6 md:mb-8">
              Start uploading receipts and let AI handle the rest. No credit
              card required.
            </p>
            <Button
              size="lg"
